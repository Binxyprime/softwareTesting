...
class TestGetStoryCases(TestCase):
    ...
    # open the door
    @story(
            'When I say "Open the door hal", I want the application to say "I\'m afraid I can\'t do that <user name>'
    ...
    # clear memory
    @story(
            'When I ask "Please clear memory" I was the application to clear user set questions and answers'
    ...
    @story(
            'When I ask "Please clear memory" I was the application to clear user set questions '
    ...
    # fav number
    @story(
            'When I tell the system "My favorite number is <number>" I want to be '
            'mocked to remind myself I am just a man.')
    ...
    # e
    @story(
            'When I ask "What is the n digit of e" I want to receive the answer'
    ...
    # color wheel
    @story('When I ask "What are color conversions" I want to know '
           'what colors I am allowed to mix.')
    ...
    def test_story_who_is_that_pokemon(self):
        obj = Interface()
